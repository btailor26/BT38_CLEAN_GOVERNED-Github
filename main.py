...
# The original Packlink path is already correct. Install the existing guard so an
# uncertain original attempt cannot create a second provider draft automatically.
