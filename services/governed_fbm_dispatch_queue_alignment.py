...
(function(){{
  ...
  var legacyTab=params.get('fbm_tab');if(legacyTab&&['ready_dispatch','pending','dispatched','cancelled','replacements','refunds'].indexOf(legacyTab)>=0)sessionStorage.setItem('bt38_fbm_loaded_'+legacyTab,'1');
